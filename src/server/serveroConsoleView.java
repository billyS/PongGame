 ...
 */
class serveroConsoleView extends JFrame implements Observer
{
  ...
  S_PongModel model = null;
 
  
  private JButton tcpButton;
  private JButton mcButton;

  public serveroConsoleView( String name )
  {
  ...
  public void drawActualPicture( Graphics2D g )
  {
    // White background
	  ...
	  tcpButton.setBounds(60, 400, 220, 30);
	  this.add(tcpButton);
	  
	  mcButton = new JButton("Connect Via MC");
	  //mcButton.setBounds(140, 400, 220, 30);
	  mcButton.setSize(220, 30);
	  this.add(mcButton, BorderLayout.SOUTH);
   ...
   */
  public void setPongController(S_PongController aPongController)
  {
